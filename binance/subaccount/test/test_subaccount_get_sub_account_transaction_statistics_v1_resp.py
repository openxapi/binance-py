    ...
    def make_instance(self, include_optional) -> SubaccountGetSubAccountTransactionStatisticsV1Resp:
        ...
        if include_optional:
            return SubaccountGetSubAccountTransactionStatisticsV1Resp(
                ...
                recent30_busd_total = '',
                trade_info_vos = [
                    binance.subaccount.models.subaccount_get_sub_account_transaction_statistics_v1_resp_trade_info_vos_inner.SubaccountGetSubAccountTransactionStatisticsV1Resp_tradeInfoVos_inner(
                        btc = 56, 
                        btc_futures = 56, 
                        btc_margin = 56, 
                        busd = 56, 
