    ...
    def make_instance(self, include_optional) -> UmfuturesGetExchangeInfoV1Resp:
        ...
        if include_optional:
            return UmfuturesGetExchangeInfoV1Resp(
                assets = [
                    binance.derivatives.umfutures.models.umfutures_get_exchange_info_v1_resp_assets_inner.UmfuturesGetExchangeInfoV1Resp_assets_inner(
                        asset = '', 
                ...
                rate_limits = [
                    binance.derivatives.umfutures.models.umfutures_get_exchange_info_v1_resp_rate_limits_inner.UmfuturesGetExchangeInfoV1Resp_rateLimits_inner(
                        interval = '', 
                        interval_num = 56, 
                        limit = 56, 
                        rate_limit_type = '', )
                ...
                server_time = 56,
                symbols = [
                    binance.derivatives.umfutures.models.umfutures_get_exchange_info_v1_resp_symbols_inner.UmfuturesGetExchangeInfoV1Resp_symbols_inner(
                        order_type = [
                            ''
                            ], 
                        base_asset = '', 
